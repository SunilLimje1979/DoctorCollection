...
#             api_url="https://drishtis.app/drishti_doctor/api/update_doctor_location/"
#             response=requests.post(api_url,json=api_data)
...
########################## insert consultaions ########################################
            ...
            dt = request.POST['followup_datetime'] if request.POST.get('followup_datetime') else None
            print(dt)
            if(dt):
...
def daycare_finalize(request):
    ...
    patient_charges_data={
            "doctor_id": request.session['doctor_id'],
            "patient_id": consult_data['patient_id'],
            "patient_status": 2,# patient added to daycare
            "charges_referencetype": 1,
            "charges_reference_id": 3,
            "charges_type": 1,
            "charges_category": 1,
